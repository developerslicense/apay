...
void testInitMoney() {
  test('test Money', () {
    ...
    expect(_getMoneyFormatted('0'), '0 ${kzt}');
    expect(_getMoneyFormatted('123'), '123 ${kzt}');
    expect(_getMoneyFormatted('012'), '12 ${kzt}');
    expect(_getMoneyFormatted('012').toString(), '12 ${kzt}');
    expect(_getMoneyFormatted('000012').toString(), '12 ${kzt}');
    expect(_getMoneyFormatted('0040012').toString(), '40 012 ${kzt}');
    expect(_getMoneyFormatted('5123'), '5 123 ${kzt}');
    expect(_getMoneyFormatted('123456'), '123 456 ${kzt}');
    expect(_getMoneyFormatted('1234567890'), '1 234 567 890 ${kzt}');
    expect(_getMoneyFormatted('12345678901234'), '1 234 567 890 ${kzt}');
    expect(_getMoneyFormatted('123.0'), '123 ${kzt}');
    expect(_getMoneyFormatted('0.0'), '0 ${kzt}');
    expect(_getMoneyFormatted('0.12'), '0 ${kzt}');
    expect(_getMoneyFormatted('5.123'), '5 ${kzt}');
    expect(_getMoneyFormatted('6.1234'), '6 ${kzt}');
    expect(_getMoneyFormatted('123456.1234'), '123 456 ${kzt}');
    expect(_getMoneyFormatted('12345678.1234'), '12 345 678 ${kzt}');
    expect(_getMoneyFormatted('1234567890.1234'), '1 234 567 890 ${kzt}');
    expect(_getMoneyFormatted('0ds&#\$%!'), '0 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!1ds&#\$%!23ds&#\$%!'), '123 ${kzt}');
    expect(_getMoneyFormatted('0ds&#\$%!12ds&#\$%!'), '12 ${kzt}');
    expect(_getMoneyFormatted('012ds&#\$%!').toString(), '12 ${kzt}');
    expect(_getMoneyFormatted('0000ds&#\$%!12').toString(), '12 ${kzt}');
    expect(_getMoneyFormatted('004ds&#\$%!0012').toString(), '40 012 ${kzt}');
    expect(_getMoneyFormatted('5ds&#\$%!123'), '5 123 ${kzt}');
    expect(_getMoneyFormatted('123456vds&#\$%!'), '123 456 ${kzt}');
    expect(_getMoneyFormatted('1ds&#\$%!234567890'), '1 234 567 890 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!12345678ds&#\$%!901234'), '1 234 567 890 ${kzt}');
    expect(_getMoneyFormatted('1ds&#\$%!23.0'), '123 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!0.0ds&#\$%!'), '0 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!0.12'), '0 ${kzt}');
    expect(_getMoneyFormatted('5.12ds&#\$%!3'), '5 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!6.1234'), '6 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!12ds&#\$%!3456.1234'), '123 456 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!1234567ds&#\$%!8.1234'), '12 345 678 ${kzt}');
    expect(_getMoneyFormatted('ds&#\$%!12345678ds&#\$%!90.1234'), '1 234 567 890 ${kzt}');
  });
}
