...
String _testGetNumberCleared(String? amount, {String? lang, bool isUserEntered = false}) {
  return getNumberCleared(amount, lang: lang, isUserEntered: isUserEntered);
}

void testsGetNumberCleared() {
...
void _testWithLang(String lang) {
  ...
  expect(_testGetNumberCleared('10000000000.00', lang: lang), '10000000000.00');
  expect(_testGetNumberCleared('10000000000.00000000', lang: lang), '10000000000.00');
  expect(_testGetNumberCleared('100000000000.00', lang: lang), '100000000000.00');
  expect(_testGetNumberCleared('1000000000000.00', lang: lang), '1000000000000.00');
  expect(_testGetNumberCleared('1000000000000.000', lang: lang), '1000000000000.00');
