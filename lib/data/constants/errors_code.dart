...
enum ErrorsCode {
  ...
  error_5999(
    ...
    'Превышен лимит \nпо карте',
    'Карта шегінен \nасып кетті',
    'Измените лимит в настройках банкинга и попробуйте снова. Либо оплатите другой картой',
    'Банк параметрлерінде шектеуді өзгертіп, әрекетті қайталаңыз. Немесе басқа картамен төлеңіз',
    tryAgainRu,
    tryAgainKz,
    'Оплатить другой картой',
    'Басқа картамен төлеңіз'
